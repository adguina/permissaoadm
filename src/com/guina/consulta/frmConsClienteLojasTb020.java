 ...
 * @author agnaldo
 */
public class frmConsClienteLojasTb020 extends javax.swing.JDialog {

    private Boolean confirmado = false;
    private Tb020clienteLojas cli;

    /**
     * Creates new form frmConsSetor
     */
    public frmConsClienteLojasTb020(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//getrs e setrs/////////////////////////////////////////////////////////////////////////
    ...
    public Tb020clienteLojas getCli() {
        return cli;
    }

    public void setCli(Tb020clienteLojas cli) {
        this.cli = cli;
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void initComponents() {
        ...
        tbCli.setFont(new java.awt.Font("Times New Roman", 0, 10)); // NOI18N
        tbCli.setForeground(new java.awt.Color(0, 51, 153));
        tbCli.setGridColor(new java.awt.Color(0, 0, 255));
        tbCli.setSelectionBackground(java.awt.Color.orange);
        tbCli.setSelectionForeground(java.awt.Color.blue);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, list, tbCli);
        ...
        if (tbCli.getColumnModel().getColumnCount() > 0) {
            tbCli.getColumnModel().getColumn(0).setMinWidth(50);
            tbCli.getColumnModel().getColumn(0).setMaxWidth(60);
            tbCli.getColumnModel().getColumn(1).setMinWidth(150);
            tbCli.getColumnModel().getColumn(1).setMaxWidth(200);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConsClienteLojasTb020.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConsClienteLojasTb020 dialog = new frmConsClienteLojasTb020(new javax.swing.JFrame(), true);
    ...
    private java.util.List<com.guina.model.Tb020clienteLojas> list;
