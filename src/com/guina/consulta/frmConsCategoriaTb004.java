 ...
 * @author agnaldo
 */
public class frmConsCategoriaTb004 extends javax.swing.JDialog {

    private Boolean confirmado = false;
    private Tb004categorias cat;

    /**
     * Creates new form frmConsSetor
     */
    public frmConsCategoriaTb004(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//getrs e setrs/////////////////////////////////////////////////////////////////////////
    ...
    public Tb004categorias getCat() {
        return cat;
    }

    public void setCat(Tb004categorias cat) {
        this.cat = cat;
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void initComponents() {
        ...
        tbCat.setFont(new java.awt.Font("Times New Roman", 0, 10)); // NOI18N
        tbCat.setForeground(new java.awt.Color(0, 51, 153));
        tbCat.setGridColor(new java.awt.Color(0, 0, 255));
        tbCat.setSelectionBackground(java.awt.Color.orange);
        tbCat.setSelectionForeground(java.awt.Color.blue);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, list, tbCat);
        ...
        if (tbCat.getColumnModel().getColumnCount() > 0) {
            tbCat.getColumnModel().getColumn(0).setMinWidth(50);
            tbCat.getColumnModel().getColumn(0).setMaxWidth(60);
            tbCat.getColumnModel().getColumn(1).setMinWidth(150);
            tbCat.getColumnModel().getColumn(1).setMaxWidth(200);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConsCategoriaTb004.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConsCategoriaTb004 dialog = new frmConsCategoriaTb004(new javax.swing.JFrame(), true);
