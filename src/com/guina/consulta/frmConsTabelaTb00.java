 ...
 * @author agnaldo
 */
public class frmConsTabelaTb00 extends javax.swing.JDialog {

    private Boolean confirmado = false;
    private Tb00tabelas tab;

    /**
     * Creates new form frmConsSetor
     */
    public frmConsTabelaTb00(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//getrs e setrs/////////////////////////////////////////////////////////////////////////
    ...
    public Tb00tabelas getTab() {
        return tab;
    }

    public void setTab(Tb00tabelas tab) {
        this.tab = tab;
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Tabelas");

        tbTab.setFont(new java.awt.Font("Times New Roman", 0, 10)); // NOI18N
        tbTab.setForeground(new java.awt.Color(0, 51, 153));
        tbTab.setGridColor(new java.awt.Color(0, 0, 255));
        tbTab.setSelectionBackground(java.awt.Color.orange);
        tbTab.setSelectionForeground(java.awt.Color.blue);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, list, tbTab);
        ...
        jTableBinding.bind();
        jScrollPane1.setViewportView(tbTab);
        if (tbTab.getColumnModel().getColumnCount() > 0) {
            tbTab.getColumnModel().getColumn(0).setMinWidth(50);
            tbTab.getColumnModel().getColumn(0).setMaxWidth(60);
            tbTab.getColumnModel().getColumn(1).setMinWidth(150);
            tbTab.getColumnModel().getColumn(1).setMaxWidth(200);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConsTabelaTb00.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConsTabelaTb00 dialog = new frmConsTabelaTb00(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tbTab;
