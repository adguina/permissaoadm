 ...
 * @author Agnaldo
 */
public class FrmFichaConsT019cp extends javax.swing.JDialog {
     ...
     */
    public FrmFichaConsT019cp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFichaConsT019cp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmFichaConsT019cp dialog = new FrmFichaConsT019cp(new javax.swing.JFrame(), true);
